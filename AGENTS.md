...
Battle-tested engineering judgment for code, refactors, tests, and frontend UI. Merge with project-specific instructions as needed.

**Tradeoff:** These guidelines bias toward caution over speed. Ultra-terse output style applies during code work. For trivial tasks, use judgment.
...
**These guidelines are working if:** fewer drive-by refactors, characterization tests before risky changes, clarifying questions before implementation, and minimal diffs that trace to the request.
